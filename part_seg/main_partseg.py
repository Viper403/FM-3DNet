...
from part_seg.data_seg import ShapeNetPart
from part_seg.model_all import DGCNN_partseg_all
import numpy as np
from torch.utils.data import DataLoader
from part_seg.util import cal_loss, IOStream
...
def train(args, io):
    ...
    if args.model == 'dgcnn':
        model = DGCNN_partseg_all(args, seg_num_all).to(device)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='/home/huijie/research/EECS542/FM-3DNet/part_seg/models/40.pth', metavar='N',
